...
var frp_googlemaps_rootclass,MarkerWithLabel,marker,bounds;
...
var frp_googlemaps = {
	...
	showOverlay: function(map,marker){
		if(!this.infowindow){
			...
			var frp_googlemaps_rootclass = this;
			this.infowindow.find('a.close').click(function(e){
				e.preventDefault();
				frp_googlemaps_rootclass.hideOverlay();
			});
	...
	monitorEscapeButton: function(){
		frp_googlemaps_rootclass = this;
		$(document).keydown(function(e) {
			if(e.keyCode === 27 && frp_googlemaps_rootclass.hideOverlay){
				frp_googlemaps_rootclass.hideOverlay();
			}
		});
	}//monitorEscapeButton
